...
class MenstruationProductInventoryCard extends HTMLElement {
  ...
  static getConfigElement() {
    return document.createElement("menstrual-cycle-companion-product-inventory-editor");
  }
  ...
  async _callInventory(action, product, quantity, extra = {}) {
    ...
    try {
      await this._hass.callService("menstrual_cycle_companion", "manage_household_inventory", serviceData);
      this._setError("");
    } catch (error) {
